...
<img src="./screenshots/Query7/normalQuery/result-set-number-of-rows.png" alt="result-set-number-of-rows" width="300px">
...
1) given query without an index
<img src="./screenshots/Query7/common/no-index.png" alt="no-index" width="300px">
<img src="./screenshots/Query7/optimizedQuery/no-index/no-index-optimize-physical-plan-graphical-explain.png" width="300px">
<img src="./screenshots/Query7/optimizedQuery/no-index/no-index-optimize-query-cost.png" width="300px">
