...
##### Explanation :
  * First , a Sequential Scan occured on boat b2 Table  to filter the  boats with color green and it costs 0..62.5,and read through 3000 Rows and 428 Rows are left after the filtration of the where condition .
  * Second , a Hash Table was built on the run on b2.bid of the 428 Rows and it costed 62.50...62.50 rows,this resulted with 1024 Buckets created ,and Memory Usage of 24 KB.
  * Thirdly , a Sequential Scan occured on reserves r2 Table to be able to hash each row's sid to the Boat b2's buckets to full inner join on the condition and it costed 00..349 rows, and it read through 19000 rows.
